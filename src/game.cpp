...
//                 window.close();
//             }
//             else if (event.key.code == sf::Keyboard::Key::A)// chap
//             {
...
//                 //---------------------------------------------
//             }
//             else if (event.key.code == sf::Keyboard::Key::D) // rast
//             {
...
//             eat.play();
//             frog_shape.setPosition(sf::Vector2f(frog1.frogStartpos(), -50)); // vaghti  be mar bokhore ghorbaghe az bin mire
//             // frog1.frog_setSpeed();
//             // // ---- update player point-----
//             // score++;
